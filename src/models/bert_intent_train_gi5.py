...
# CONFIG
# =====================
DATA = "data/processed/gi5_train.csv"
OUT = Path("models_saved/intent_gi5")
MODEL = "bert-base-uncased"
TRAIN_CSV = "data/processed/gi5_train_contrastive.csv"
...
TrainingArguments(
    ...
    num_train_epochs=12,        # was 8
    learning_rate=2e-5,         # keep stable
